...
const ProductSheet: React.FC = () => {
    ...
    const { isOpen, closeSheet, activeProduct, variantId, loading, merchants, otherProducts, activateAnimation } = useProductSheet();
    ...
    const sameEanVariants = activeProduct.variants
