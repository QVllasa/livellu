...
import {CategoryMenu} from "@/components/layouts/menu/category-menu"; // Assuming you are using lucide-react icons
      ...
      >
          ...
          <div className={'flex flex-col'}>
              ...
              >
                  ...
                  <ul className="flex flex-col hidden shrink-0 items-center space-x-7 rtl:space-x-reverse lg:flex 2xl:space-x-10">
                      <Navigation/>
                      <CategoryMenu/>
                  </ul>
